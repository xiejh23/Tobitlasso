...
%     betaHat1 = glmnetFn(X,y,lambda_n);
    betaHat1 = lasso(X,y,'Lambda',lambda_n);
...
vec_rmse=[(sum(beta1_r)/M)^0.5;(sum(beta2_r)/M)^0.5;(sum(beta4_r)/M)^0.5;(sum(beta7_r)/M)^0.5;(sum(beta3_r)/M)^0.5;(sum(beta5_r)/M)^0.5;(sum(beta6_r)/M)^0.5];
...
vec_rmse2=[(sum(sum(beta1_b.^2))/M)^0.5;(sum(sum(beta2_b.^2))/M)^0.5;(sum(sum(beta4_b.^2))/M)^0.5;(sum(sum(beta7_b.^2))/M)^0.5;(sum(sum(beta3_b.^2))/M)^0.5;(sum(sum(beta5_b.^2))/M)^0.5;(sum(sum(beta6_b.^2))/M)^0.5];
